...
The model which is currently in the lead on each bench is less important than the fact that significant progress is still being made. There is no sign that AI has hit a scaling limit yet.
