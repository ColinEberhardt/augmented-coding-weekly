...
author: ceberhardt
published: true
thumbnail: img/48.png
summary: Anthropic's Fable 5 shows major capability gains and strong security performance, while also raising questions about safety guardrails and its short-lived token pricing. The issue rounds out with reflections on AI's relentless, messy impact on software engineering, from proactive agents to the tension between speed, quality, and control.
---
...
![Fable 5]({{ "img/48.png" | absolute_url }})
...
<small>ONEUSEFULTHING.ORG</small>
...
Ethan shares the results of some of his experiments, which are very impressive, complex and rather novel applications. For example this [Isochronic Passage Chart](https://isochronic-passage-chart.netlify.app/).
...
## [Geoffrey Hinton: AI Is Conscious, Superintelligence is Coming, And We Should Be Worried](https://pod.link/1522960417/episode/ODhiMTAzYzgtNWY3NS0xMWYxLTg0NmItZWI0MmZjNjU0MjVm)
