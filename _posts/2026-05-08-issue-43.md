...
author: ceberhardt
published: true
thumbnail: img/43.jpeg
summary: This issue explores the rapid evolution of agentic coding harnesses, with Anthropic and open source projects racing to embed self-improving features and best practices. It also examines the growing tension between trust in AI agents and the need for human oversight as agentic workflows become more mainstream.
---

## [Code w/ Claude](https://claude.com/code-with-claude/)

<small>CLAUDE.COM</small>
...
![event]({{ "img/43.jpeg" | absolute_url }})

There were some updates to Claude Code announced, including [dreaming and outcomes](https://claude.com/blog/new-in-claude-managed-agents) for managed agents (agents that execute on remote environments rather than on the developers machine). The 'dreaming' feature is one I am most interested in:
...
A few months ago, while [experimenting with agentic loops](https://blog.scottlogic.com/2025/12/22/power-of-agentic-loops.html), I discovered that you can create a self-improving agent by asking it to reflect on its thought process and add instruction that help optimise future runs. Great to see this becoming a first-class feature of the product.
...
## [Event: Software Engineering for the AI Age](https://beyondthehype.events/)

<small>BEYONDTHEHYPE.EVENTS</small>
