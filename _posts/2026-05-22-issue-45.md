...
summary: The Web Dev State of AI 2026 survey reveals that AI-assisted coding has transitioned from experiment to standard practice, with developers now generating 54% of their code with AI, though concerns about job security and long-term skill degradation are rising. Meanwhile, open source maintainers are grappling with an explosion of AI-generated slop that's forcing them to erect contribution barriers, while the industry debates whether junior developer roles remain viable in an AI-augmented world.
---
...
![state of webdev results]({{ "img/45.png" | absolute_url }})
...
## [AI didn't kill your junior pipeline. You did](https://andrewmurphy.io/blog/ai-didnt-kill-your-junior-pipeline-you-did)

<small>ANDREWMURPHY.COM</small>
