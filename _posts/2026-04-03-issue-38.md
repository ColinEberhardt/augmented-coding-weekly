...
author: ceberhardt
published: true
thumbnail: img/38.png
summary: This week's bombshell was the accidental leak of Claude Code's source code via an npm sourcemap, revealing controversial features like undercover mode and user frustration detection. Meanwhile, GitHub faced backlash for Copilot inserting product advertisements into pull requests, highlighting ongoing concerns about AI tool transparency and corporate overreach.
---

## [Anatomy of the .claude/ Folder](https://blog.dailydoseofds.com/p/anatomy-of-the-claude-folder)

<small>DAILYDODEOFDS.COM</small>

Last week I shared a [Claude Code Cheat Sheet](https://cc.storyfox.cz/) that I am finding very useful. Claude Code, like many chat interfaces, has a discoverability issue (something I [wrote about just over a year ago](https://blog.scottlogic.com/2025/02/21/ais-biggest-flaw-the-blinking-cursor-problem.html)), it is far from obvious what it is capable of, and in the AI-age we are even less likely to read the manual. 
...
![cheat sheet]({{ "img/38.png" | absolute_url }})
...
<small>ZACHMANSON.COM</small>

In this (brief) post, Zach drew attention to an advertisement at the bottom of a pull request opened by GitHub Copilot. 

Apparently this has been going on for a while, with an [astonishing 1.5 million pull requests](https://github.com/search?q=%22%3C%21--+START+COPILOT+CODING+AGENT+TIPS+--%3E%22&type=pullrequests&s=updated&o=asc&p=1) featuring messages such as this:
...
## [Claw Code - a Rust re-implementation of Claude Code](https://github.com/ultraworkers/claw-code)
...
The rush of Claude Code rewrites once again highlights the controversial topic of "clean room", and whether an AI model can be considered 'clean', and these rewrites considered legal (in that that they don't violate copyright). A topic we [touched on back in issue 34](https://augmentedcoding.dev/issue-34/).
