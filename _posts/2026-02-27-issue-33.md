...
author: ceberhardt
published: true
thumbnail: img/33.jpg
summary: AI agents are enabling unprecedented rapid development, with examples like Ladybird's week-long JavaScript engine migration from C++ to Rust and Cloudflare's recreation of Next.js, both powered by comprehensive test suites that validate AI-generated code. This speed raises uncomfortable questions about whether good engineering practices like documentation and tests have become competitive vulnerabilities, while developers grapple with new workflows that emphasize planning over direct coding.
---

## [Ladybird adopts Rust, with help from AI](https://ladybird.org/posts/adopting-rust/)

<small>LADYBIRD.ORG</small>
...
I wonder how many open source projects are going to start removing their tests? It's already happened with [one prominent project](https://github.com/tldraw/tldraw/issues/8082).
...
## [AI? Don't Panic!](https://blog.ttulka.com/ai-dont-panic/)
...
![Dont Panic]({{"img/33.jpg"| absolute_url}})
