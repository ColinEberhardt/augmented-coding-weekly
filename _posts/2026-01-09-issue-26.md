...
summary: AI agents are disrupting software development in unexpected ways, from destroying documentation traffic and open source business models, to industrializing code production, spawning chaotic multi-agent factories, and enabling coding from smartphones. 
---
...
![Gas Town]({{"img/26.jpg"| absolute_url}})
...
So what actually is Gas Town? the [code is on GitHub](https://github.com/steveyegge/gastown) if you'd like a look. it is an AI agent orchestration framework designed to manage and scale multiple autonomous coding agents in a coordinated workflow. It acts like a workspace manager that persists work state and provides structured roles and coordination patterns so many agents can work concurrently without losing context. Sounds wonderful, but it is clearly a proof of concept:
...
It it worth reading this article? Sure, it's a lot of fun! (and Steve published a [17 min read-time follow up](https://steve-yegge.medium.com/the-future-of-coding-agents-e9451a84207c) just days after)
