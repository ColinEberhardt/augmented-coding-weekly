...
author: ceberhardt
published: true
thumbnail: img/27.png
summary: This week explores how to safely harness coding agents through sandboxing approaches like Bubblewrap and Yolobox, allowing developers to embrace Yolo mode without the risk of exposing secrets or damaging their systems. We also look at Ramp's sophisticated background agent that integrates visual verification into the development loop, and examine the growing problem of hype-first narratives that obscure the real effort and context behind AI achievements.
---

## [A better way to limit Claude Code (and other coding agents!) access to Secrets](https://patrickmccanna.net/a-better-way-to-limit-claude-code-and-other-coding-agents-access-to-secrets/)

<small>PATRICKMCCANNA.NET</small>
...
## [Yolobox - Let your AI go full send](https://github.com/finbarr/yolobox)
...
## [The Influentists](https://carette.xyz/posts/influentists/)

<small>CARETTE.XYZ</small>

This post highlights the growing trend of _"hype first and context later"_.
